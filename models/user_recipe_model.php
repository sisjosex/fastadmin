...
class UserRecipeModel extends Module
{
    function __construct()
    {
        parent::__construct('user_recipe', 'id');

        $this->phisical_table = DB_PREFIX . 'user_recipe';
        ...
        $this->addField(
            array(
                ...
                'validation' => array(
                    ...
                    'messages' => array(
                        'required' => lang('Porciones es requerida')
                    )
                ),
                'attr' => array(
                    array('name' => 'placeholder', 'value' => lang('Porciones'))
                ),
                "group" => "column2",
            )
        );
        ...
        $this->addGroup('form', array('id', 'user_id', 'food_id', 'portions'));
        $this->addGroup('grid', array('id', 'food', 'portions'));
    }
}