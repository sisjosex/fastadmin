...
class Calculadora_calorias_Model extends Module
{
    function __construct()
    {
        parent::__construct('calculadora_calorias', 'id');
        ...
        $this->addField(
            array(
                "key" => "calorias_por_kcal",
                "name" => lang("Calorias por Kcal"),
                "type" => "text",
                'validation' => array(
                    'rules' => array(
                        'required' => true,
        ...
        $this->addGroup('form', array('id', 'categoria_id', 'ingredient_id', 'calorias_por_kcal', 'peso_racion', 'calorias'));
        $this->addGroup('grid', array('id', 'categoria', 'alimento', 'calorias_por_kcal', 'peso_racion', 'calorias'));
    }
