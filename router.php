...
require_once(BASE_PATH . "language/$language.php");
...
if($controllerNotExists) {
    ...
    if( !file_exists($controller_path) && !is_dir($path) && !is_dir($controller_path) ) {
    ...
    if( !file_exists($controller_path) ) {
        error_404("Controller1does not exists $controller_path");
    }
